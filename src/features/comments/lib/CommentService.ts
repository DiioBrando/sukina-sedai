...
export default class CommentService {
  static async addComment(_id: string, comment: string): Promise<void> {
    return $apiComment.post('/add-comment', { _id, comment });
  }
  static async updateComment(_id: string, comment: string): Promise<void> {
    return $apiComment.post('/update-comment', { _id, comment });
  }

  static async deleteComment(_id: string): Promise<void> {
    return $apiComment.post('/delete-comment', { _id });
  }
